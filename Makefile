...
vecliball_pp31.h: Makefile *.h
	...
	uncrustify -f vecliball_pp.tmp12 -l CPP -o vecliball_pp31.h
...
vecliball_pp30.h: Makefile *.h
	...
	uncrustify -f vecliball_pp.tmp22 -l CPP -o vecliball_pp30.h
...
vecliball_pp20.h: Makefile *.h
	...
	uncrustify -f vecliball_pp.tmp32 -l CPP -o vecliball_pp20.h
	rm vecliball_pp.tmp31 vecliball_pp.tmp32

vecliball_pp10.h: Makefile *.h
	$(CC) $(FLAGS) -msse -include veclib_conf.h vecliball.h -o vecliball_pp.tmp41 -E
	grep vecliball_pp.tmp41 -e ^[^#] > vecliball_pp.tmp42
	uncrustify -f vecliball_pp.tmp42 -l CPP -o vecliball_pp10.h
	rm vecliball_pp.tmp41 vecliball_pp.tmp42

vecliball_pp00.h: Makefile *.h
	$(CC) $(FLAGS) -include veclib_conf.h vecliball.h -o vecliball_pp.tmp51 -E
	grep vecliball_pp.tmp51 -e ^[^#] > vecliball_pp.tmp52
	uncrustify -f vecliball_pp.tmp52 -l CPP -o vecliball_pp00.h

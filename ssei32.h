...
public:
	...
	i32x4 operator-() const { return _mm_sub_epi32(_mm_setzero_si128(),m); }
	i32x4 operator~() const { return _mm_andnot_si128(m,_mm_set1_epi32(~0)); }

	i32x4b operator!() const;
	operator i32x4bn() const;
...
template <unsigned bits> inline i32x4 Shl(i32x4 in)	{ i32x4 out(_mm_slli_epi32(in.m,bits)); return out; }
template <unsigned bits> inline i32x4 Shr(i32x4 in)	{ i32x4 out(_mm_srli_epi32(in.m,bits)); return out; }

// Correct up to 23 bits; UAYOR
inline i32x4 FastMul(i32x4 ta,i32x4 tb) {
	i32x4 out;
...
// Correct up to 23 bits; UAYOR
inline i32x4 FastDiv(i32x4 ta,i32x4 tb) {
	i32x4 out;
	__m128 a=_mm_cvtepi32_ps(ta.m),b=_mm_cvtepi32_ps(tb.m);
...
public:
	...
	i32x4b operator^(i32x4b v) const	{ return _mm_xor_si128(m,v.m); }
	i32x4b operator&&(i32x4b v) const	{ return _mm_and_si128(m,v.m); }
	i32x4b operator||(i32x4b v) const	{ return _mm_or_si128(m,v.m); }

	i32x4b(f32x4b v)					:m(_mm_castps_si128(v.m)) { }
	operator f32x4b() const				{ return _mm_castsi128_ps(m); }
...
{
public:
	i32x4bn operator^(i32x4b v) const	{ return _mm_xor_si128(m,v.m); }
	i32x4b operator^(i32x4bn v) const	{ return _mm_xor_si128(m,v.m); }
	i32x4b operator!() const			{ return i32x4b(m); }

	i32x4b operator&&(i32x4b v) const	{ return _mm_andnot_si128(m,v.m); }
	i32x4bn operator&&(i32x4bn v) const	{ return _mm_or_si128(m,v.m); }

	i32x4bn operator||(i32x4bn v) const	{ return _mm_and_si128(m,v.m); }
	i32x4b operator||(i32x4b v) const	{ return _mm_or_si128(_mm_andnot_si128(m,_mm_set1_epi32(~0)),v.m); }
	operator i32x4b() const				{ return _mm_andnot_si128(m,_mm_set1_epi32(~0)); }

//	i32x4bn(const f32x4bn &v)			:m(_mm_castps_si128(v.NegM())) { }
//	operator f32x4bn() const			{ return _mm_castsi128_ps(m); }

	__m128i NegM() const { return m; }
private:
	i32x4bn(__m128i m) :m(m) { }
	friend i32x4bn operator!(i32x4b);
	friend i32x4bn operator^(i32x4b, i32x4bn);
	friend i32x4bn operator!=(i32x4, i32x4);
	friend i32x4bn operator<=(i32x4, i32x4);
	friend i32x4bn operator>=(i32x4, i32x4);
...
inline i32x4::operator i32x4bn() const { return i32x4bn(_mm_cmpeq_epi32(m,_mm_setzero_si128())); }
inline i32x4b i32x4::operator!() const { return i32x4b(_mm_cmpeq_epi32(m,_mm_setzero_si128())); }

inline i32x4bn operator!(i32x4b v)						{ return i32x4bn(v.m); }
inline i32x4bn operator^(i32x4b a,i32x4bn b)		{ return i32x4bn(_mm_xor_si128(a.m,b.NegM())); }
inline i32x4b operator&&(i32x4b a,i32x4bn b)		{ return _mm_andnot_si128(b.NegM(),a.m); }
inline i32x4b operator||(i32x4b a,i32x4bn b)
...
inline i32x4bn	operator!=(i32x4 a,i32x4 b) { return _mm_cmpeq_epi32(a.m,b.m); }
inline i32x4b 	operator==(i32x4 a,i32x4 b) { return _mm_cmpeq_epi32(a.m,b.m); }
inline i32x4b	operator< (i32x4 a,i32x4 b) { return _mm_cmplt_epi32(a.m,b.m); }
inline i32x4b	operator> (i32x4 a,i32x4 b) { return _mm_cmpgt_epi32(a.m,b.m); }
inline i32x4bn	operator<=(i32x4 a,i32x4 b) { return _mm_cmpgt_epi32(a.m,b.m); }
inline i32x4bn	operator>=(i32x4 a,i32x4 b) { return _mm_cmplt_epi32(a.m,b.m); }

inline i32x4 Condition(i32x4b test,i32x4 v1,i32x4 v2)
	{ return _mm_or_si128(_mm_and_si128(test.m,v1.m),_mm_andnot_si128(test.m,v2.m)); }
inline i32x4 Condition(i32x4b test,i32x4 v1)
	{ return _mm_and_si128(test.m,v1.m); }
inline i32x4 Condition(i32x4bn test,i32x4 v1,i32x4 v2)
	{ return _mm_or_si128(_mm_andnot_si128(test.NegM(),v1.m),_mm_and_si128(test.NegM(),v2.m)); }
inline i32x4 Condition(i32x4bn test,i32x4 v1)
